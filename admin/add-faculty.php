...
?>
    ...
    <head>
        ...
        <title>Add Faculty | JSSATEN-FMS</title>
                            ...
                            <form method="post">
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <th>Designation</th>
                                            <td><input class="form-control" id="designation" name="designation" type="text" required /></td>
                                        </tr>
                                        <tr>
                                            <th>Subject Allotted</th>
                                            <td><input class="form-control" id="subjectalloted" name="subjectalloted" type="text" required /></td>
                                        </tr>
                                        <tr>
                                            <th>Password</th>
                                        ...
                                        <tr>
                                            <th>Mobile</th>
                                            <td><input class="form-control" id="mobile" name="mobile" type="text" required /></td>
                                        </tr>
                                        <tr>
                                            <th>Department</th>
                                            <td><input class="form-control" id="dept" name="dept" type="text" required /></td>
                                        </tr>
                                        <tr>
